...
export CROSS_COMPILE=${HOME}/ak/AK-linaro/4.9.1-2014.07.20140718.CR83/bin/arm-cortex_a15-linux-gnueabihf-
export ARCH=arm
export SUBARCH=arm
...
MODULES_DIR=${HOME}/ak/AK-anykernel/cwm/system/lib/modules
KERNEL_DIR=`pwd`
OUTPUT_DIR=${HOME}/ak/AK-anykernel/zip
CWM_DIR=${HOME}/ak/AK-anykernel/cwm
ZIMAGE_DIR=${HOME}/ak/AK-xGenesis/arch/arm/boot
CWM_MOVE=${HOME}/ak/AK-releases
ZIMAGE_ANYKERNEL=${HOME}/ak/AK-anykernel/cwm/kernel
ANYKERNEL_DIR=${HOME}/ak/AK-anykernel
